...
class OrderQuery extends Driver
{
    public function request(RequestInterface $request): ResponseInterface
    {
        ...
        // {
        //     "amount": "1000",
        //     "mchOrderNo": "sanzy_order43339629",
        //     "productId": "8006",
        //     "payOrderId": "SA202306201356098692347",
        //     "status": "1",
        //     "mchId": "10008",
        //     "paySuccTime": "",
        //     "retCode": "SUCCESS",
        //     "sign": "E5792CDE12C13680AB4C0E091136EC63"
        // }
    ...
    public function transferOrderInfo(array $data, array $order): array
    {
        ...
        return [
            ...
            'order_no' => $data['mchOrderNo'], // 我司訂單號
            'trade_no' => $data['payOrderId'], // 三方交易號
            'payment_platform' => $order['payment_platform'],
            'payment_channel' => $order['payment_channel'],
            'status' => $this->transformStatus($data['status']), // 轉換訂單狀態
            'remark' => '',
