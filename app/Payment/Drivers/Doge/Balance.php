...
class Balance extends Driver
{
    public function request(RequestInterface $request): ResponseInterface
    {
        ...
        // {"data":{"available_balance":0,"balance":"0.00","frozen_balance":"0.00","name":"江山yg8888","username":"yg8888","sign":"fc61c53e5fbedcf3f38836fae4ffc70a"},"http_status_code":201,"message":"查询成功"}
    ...
    public function transferBalance(array $data = [], array $input = []): array
    {
        $fdata = [
            ...
            'balance' => $this->revertAmount($data['available_balance']),
    ...
    {
        $params = [
            'username' => $input['merchant_id'], // 商户ID
        ];
