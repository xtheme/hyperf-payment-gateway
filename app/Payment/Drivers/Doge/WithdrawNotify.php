...
class WithdrawNotify extends WithdrawQuery
{
    ...
    {
        // {"data":{"order_number":"doge_withdraw_26722120","system_order_number":"GX20240430135702121867","username":"yg8888","amount":"2000.00","status":5,"sign":"2cdda994bc3d57db408fea778166e7a5"},"http_status_code":200,"error_code":0,"message":"异步回调"}
        ...
        // 更新订单
        $update = [
            'status' => $this->transformWithdrawStatus($callback['data']['status']),
