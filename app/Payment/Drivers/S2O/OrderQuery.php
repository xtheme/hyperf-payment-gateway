...
class OrderQuery extends Driver
{
    ...
    public function transferOrderInfo(array $data, array $order): array
    {
        ...
        return [
            'amount' => $this->revertAmount($data['original_amount']), // 金額
            'real_amount' => $this->revertAmount($data['original_amount']), // 金額
            'order_no' => $data['cus_order_sn'], // 商戶訂單號
            'trade_no' => $data['order_sn'], // 三方訂單號
            'payment_platform' => $order['payment_platform'],
            'payment_channel' => $order['payment_channel'],
            'status' => $this->transformStatus($data['order_status']), // 訂單狀態
