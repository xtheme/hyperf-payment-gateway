...
class WithdrawCreate extends Driver
{
    ...
    public function request(RequestInterface $request): ResponseInterface
    {
        ...
        $data = [
            ...
            'trade_no' => $response['order_info']['order_sn'] ?? '', // 三方交易号
        ];
    ...
    protected function prepareOrder(string $orderNo, array $data = []): array
    {
        ...
        $params = [
            'cus_code' => $data['merchant_id'],
            'cus_order_sn' => $orderNo,
            'payment_flag' => $data['payment_channel'],
            'amount' => $this->convertAmount($data['amount']),
            'bank_code' => self::BANK_CODE_MAP[$data['bank_code']],
