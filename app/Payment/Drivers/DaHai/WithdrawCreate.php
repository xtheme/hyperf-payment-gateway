...
class WithdrawCreate extends Driver
{
    ...
    protected function prepareOrder(string $orderNo, array $data = []): array
    {
        $params = [
            ...
            'CurrencyId' => 1,
            'IsTest' => false,
            'PayeeAccountName' => $data['user_name'],
            'PayeeAccountNumber' => $data['bank_account'],
            'PaymentChannelId' => intval($data['payment_channel']), // 通道類型
            'ShopInformUrl' => $this->getWithdrawNotifyUrl($data['payment_platform']),
            'ShopOrderId' => $orderNo,
            'ShopUserLongId' => $data['merchant_id'],
        ];
