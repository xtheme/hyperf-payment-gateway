...
class OrderCreate extends Driver
{
    ...
    public function request(RequestInterface $request): ResponseInterface
    {
        ...
        // 三方返回数据示例
        // {
        //     "payOrderId": "P01274620231004022409393",
        //     "sign": "08E0363F0B69332B43751A109880E2FB",
        //     "payParams": {
        //         "payUrl": "https://cashier.heropays.com/antimalicious_cashier.html?P01274620231004022409393"
        //     },
        //     "retCode": "SUCCESS"
        // }
    ...
    protected function prepareOrder(string $orderNo, array $data = []): array
    {
        ...
        $params = [
            ...
            'mchOrderNo' => $orderNo,
            'currency' => $data['currency'] ?? 'CNY',                              // 商户订单号
