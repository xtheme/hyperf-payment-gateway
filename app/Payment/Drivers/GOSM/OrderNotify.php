...
class OrderNotify extends OrderQuery
{
    ...
    {
        // {"account":"CAVY80VK","amount":1,"fixAmount":1,"receiveType":"aliPay","signedMsg":"3763e9eac942be1571074225c4294cd1329c3f7e4127034c4ef131e09568ca94","status":"COMPLETED","storeOrderCode":"gosm_73093277","systemOrderCode":"PA2024053014100255364"}
        $callback = $request->all();

        $orderNo = $callback['storeOrderCode'] ?? '';
        ...
        $update = [
            ...
            'real_amount' => $callback['fixAmount'],
            'trade_no' => $callback['systemOrderCode'],
        ];
        ...
        // 返回数据给集成网关更新
        $callback['newAmount'] = $callback['fixAmount'];
        $callback['SystemOrderId'] = $callback['systemOrderCode'];
