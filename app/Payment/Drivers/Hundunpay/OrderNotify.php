...
class OrderNotify extends OrderQuery
{
    ...
    public function request(RequestInterface $request): ResponseInterface
    {
        ...
        // {
        //     "order": "8e00e2b36d5815c21c567f3a",
        //     "sh_order": "hundunpay_23062017081ae8ds",
        //     "money": "300.00",
        //     "status": "1",
        //     "sign": "1da2c29defb5efb22407c0a152acafbb"
        // }

        // 回調請求中的商戶訂單號
        $orderNo = $callback['sh_order'] ?? '';
        ...
        $update = [
            ...
            'real_amount' => $this->revertAmount($callback['money']),
            'trade_no' => $callback['order'],
        ];
